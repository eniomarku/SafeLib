...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/nuc/graphene_test/graphene/Examples/redis/src/deps/jemalloc/ /home/nuc/graphene_test/graphene/Examples/redis/src/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/nuc/graphene_test/graphene/Examples/redis/src/deps/jemalloc/ /home/nuc/graphene_test/graphene/Examples/redis/src/deps/jemalloc/

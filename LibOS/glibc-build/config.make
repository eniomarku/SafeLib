...
prefix = /home/nuc/graphene_test/graphene/LibOS/../Runtime
exec_prefix = ${prefix}
datadir = ${datarootdir}
...
CXX = g++
BUILD_CC = 
CFLAGS = -O2 -Wp,-U_FORTIFY_SOURCE -fno-stack-protector -Wno-unused-value -g
CPPFLAGS-config = 
CPPUNDEFS = 
...
config-cflags-mprefer-vector-width = no
enable-cet = no
build-mathvec = yes
have-ifunc = yes

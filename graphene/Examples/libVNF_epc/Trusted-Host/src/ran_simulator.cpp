...
void simulate(int arg) {
	...
	while (1) {
		...
		printf("RIDER REPORT: ran simulate function 1111 g_tot_regs=%d\n", g_tot_regs); fflush(stdout);
		...
		*/ 
		...
		// rider added 2021-1-4 disabled data traffic
		// /* Data transfer */
...
void run() {
	...
	/* Tun */
	g_traf_mon.tun.set_itf("tun1", "192.168.2.1/24");

...
string g_hss_ip_addr = "169.254.9.9"; // type 2
string g_sgw_s11_ip_addr = "169.254.9.9"; // type 1
string g_sgw_s1_ip_addr = "169.254.9.9"; // type 1
string g_sgw_s5_ip_addr = "169.254.9.9"; // type 1
string g_pgw_s5_ip_addr = "169.254.9.9"; // type 1
int g_trafmon_port = 4000;
int g_mme_port = 5000;
int g_hss_port = 6000;
int g_sgw_s11_port = 6001; //7000;
int g_sgw_s1_port = 6002; //7100;
int g_sgw_s5_port = 6003; //7200;
int g_pgw_s5_port = 8000;

uint64_t g_timer = 100;
string t_ran_ip_addr = "169.254.9.9"; // type 1
int t_ran_port = 4905;

string s_ran_ip_addr = "169.254.9.9"; // type 1
int s_ran_port = 4905;
